...
int main()
{
    ...
    std::cout << "Executed " << run_instructions_throughput_add << " in " << diff_throughput_add.count() << " milliseconds." << std::endl
              << "Resulting in " << run_instructions_throughput_add / diff_throughput_add.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
    ...
    std::cout << "Executed " << run_instructions_throughput_mul << " in " << diff_throughput_mul.count() << " milliseconds." << std::endl
              << "Resulting in " << run_instructions_throughput_mul / diff_throughput_mul.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
    ...
    std::cout << "Executed " << run_instructions_latency_add << " in " << diff_latency_add.count() << " milliseconds." << std::endl
              << "Resulting in " << run_instructions_latency_add / diff_latency_add.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
    ...
    std::cout << "Executed " << run_instructions_latency_mul << " in " << diff_latency_mul.count() << " milliseconds." << std::endl
              << "Resulting in " << run_instructions_latency_mul / diff_latency_mul.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
