...
int main()
{
    ...
    std::cout << "Executed " << run_instructions_throughput_add << " \"Add\" Instructions in " << diff_throughput_add.count() << " milliseconds." << std::endl
              << "Resulting in a Throughput of " << run_instructions_throughput_add / diff_throughput_add.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
    ...
    std::cout << "Executed " << run_instructions_throughput_mul << " \"Mul\" Instructions in " << diff_throughput_mul.count() << " milliseconds." << std::endl
              << "Resulting in a Throughput of " << run_instructions_throughput_mul / diff_throughput_mul.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
    ...
    std::cout << "Executed " << run_instructions_latency_add << " \"Add\" Instructions in " << diff_latency_add.count() << " milliseconds on a single Unit." << std::endl
              << "Resulting in a Throughput of " << run_instructions_latency_add / diff_latency_add.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
    ...
    std::cout << "Executed " << run_instructions_latency_mul << " \"Mul\" Instructions in " << diff_latency_mul.count() << " milliseconds on a single Unit." << std::endl
              << "Resulting in a Throughput of " << run_instructions_latency_mul / diff_latency_mul.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
