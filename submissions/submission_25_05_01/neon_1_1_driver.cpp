...
int main()
{
    ...
    std::cout << "Executed " << run_instructions_throughput_fmla_4s << " \"FMLA 4s\" Instructions in " << diff_throughput_fmla_4s.count() << " milliseconds." << std::endl
              << "Resulting in a Throughput of " << run_instructions_throughput_fmla_4s / diff_throughput_fmla_4s.count() * 1000 << " Instructions per Second!"
              << std::endl
              << std::endl;
