...
void mini_jit::kernels::matmul_16m_4nRest_k(mini_jit::Kernel& kernel, const uint32_t m_loop_16, const uint32_t n_loop_4,
    const uint32_t k_loop, const uint32_t n_loop_rest)
{
