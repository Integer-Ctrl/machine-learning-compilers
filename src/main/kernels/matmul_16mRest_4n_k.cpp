    ...
    const uint32_t k_loop, const uint32_t m_loop_rest)
{
    ...
    uint32_t revert_offset_x2 = offset_from_full_loads >= 4 ?
        sub(x2, x2, offset_from_full_loads - 4) : add(x2, x2, 4 - offset_from_full_loads);
    uint32_t revert_offset_x0 = offset_from_full_loads >= 4 ?
        sub(x0, x0, offset_from_full_loads - 4) : add(x0, x0, 4 - offset_from_full_loads);
    ...
    case 3: // 3s
        ...
        instruction1_fp_loads_less_than_4 = {
            ldrPre(q28, x2, offset_from_full_loads - 4),
            revert_offset_x2
        };
        instruction2_fp_loads_less_than_4 = {
            ldrPre(q20, x2, offset_from_full_loads - 4),
            revert_offset_x2
        };
        instruction3_fp_loads_less_than_4 = {
            ldrPre(q24, x2, offset_from_full_loads - 4),
            revert_offset_x2
        };
        instruction4_fp_loads_less_than_4 = {
            ldrPre(q8, x2, offset_from_full_loads - 4),
            revert_offset_x2
        };
    ...
    case 0:
        if (m_loop_remainder != 0)
        {
            ...
            jump_N_loop += 4
                + instruction1_fp_loads_less_than_4.size()
                + instruction2_fp_loads_less_than_4.size()
                + instruction3_fp_loads_less_than_4.size()
                + instruction4_fp_loads_less_than_4.size();
        }
    ...
    case 1: // 1s
        // Using the always last register that are unused
        instruction1_fp_store_less_than_4 = {
            strOffset(s28, x2, offset_from_full_loads)
        };
        instruction2_fp_store_less_than_4 = {
            strOffset(s20, x2, offset_from_full_loads)
        };
        instruction3_fp_store_less_than_4 = {
            strOffset(s24, x2, offset_from_full_loads)
        };
        instruction4_fp_store_less_than_4 = {
            strOffset(s8, x2, offset_from_full_loads)
        };
        break;
    case 2: // 2s
        instruction1_fp_store_less_than_4 = {
            strOffset(d28, x2, offset_from_full_loads)
        };
        instruction2_fp_store_less_than_4 = {
            strOffset(d20, x2, offset_from_full_loads)
        };
        instruction3_fp_store_less_than_4 = {
            strOffset(d24, x2, offset_from_full_loads)
        };
        instruction4_fp_store_less_than_4 = {
            strOffset(d8, x2, offset_from_full_loads)
        };
        break;
    case 3: // 3s
        ...
        if (m_loop_full_4s == 0)
        {
            uint32_t apply_offset_x2 = offset_from_full_loads >= 4 ?
                add(x2, x2, offset_from_full_loads - 4) : sub(x2, x2, 4 - offset_from_full_loads);
        ...
        else
        {
            // ldrOffset cannot be used as it only supports positive and multiple of 16 numbers.
            instruction1_fp_store_less_than_4 = {
                strPre(q28, x2, offset_from_full_loads - 4),
                revert_offset_x2
            };
            instruction2_fp_store_less_than_4 = {
                strPre(q20, x2, offset_from_full_loads - 4),
                revert_offset_x2
            };
            instruction3_fp_store_less_than_4 = {
                strPre(q24, x2, offset_from_full_loads - 4),
                revert_offset_x2
            };
            instruction4_fp_store_less_than_4 = {
                strPre(q8, x2, offset_from_full_loads - 4),
                revert_offset_x2
            };
        }
    ...
    case 0:
        if (m_loop_remainder != 0)
        {
            ...
            jump_N_loop += 4
                + instruction1_fp_store_less_than_4.size()
                + instruction2_fp_store_less_than_4.size()
                + instruction3_fp_store_less_than_4.size()
                + instruction4_fp_store_less_than_4.size();
        }
        break;
