...
void mini_jit::kernels::br_matmul_16mRest_lt4nRest_k(mini_jit::Kernel &kernel, const uint32_t m_loop_16, const uint32_t n_loop_4,
                                                     ...
                                                     const uint32_t n_loop_rest)
{
  ...
  kernel.write("br_matmul_16mRest_lt4nRest_k.bin");
