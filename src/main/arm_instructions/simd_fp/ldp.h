#ifndef MINI_JIT_ARM_INSTRUCTIONS_SIMD_FP_LDP_H
#define MINI_JIT_ARM_INSTRUCTIONS_SIMD_FP_LDP_H
...
namespace mini_jit
{
  namespace arm_instructions
  {
    ...
    {
      return internal::ldpPost(static_cast<uint32_t>(St1), static_cast<uint32_t>(St2), static_cast<uint32_t>(Xn), imm7,
                               internal::ldpSimdFpDataTypes::v32bit);
    }

    constexpr uint32_t ldpPost(const V64Bit Dt1, const V64Bit Dt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpPost(static_cast<uint32_t>(Dt1), static_cast<uint32_t>(Dt2), static_cast<uint32_t>(Xn), imm7,
                               internal::ldpSimdFpDataTypes::v64bit);
    }

    constexpr uint32_t ldpPost(const V128Bit Qt1, const V128Bit Qt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpPost(static_cast<uint32_t>(Qt1), static_cast<uint32_t>(Qt2), static_cast<uint32_t>(Xn), imm7,
                               internal::ldpSimdFpDataTypes::v128bit);
    }

    constexpr uint32_t ldpPre(const V32Bit St1, const V32Bit St2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpPre(static_cast<uint32_t>(St1), static_cast<uint32_t>(St2), static_cast<uint32_t>(Xn), imm7,
                              internal::ldpSimdFpDataTypes::v32bit);
    }

    constexpr uint32_t ldpPre(const V64Bit Dt1, const V64Bit Dt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpPre(static_cast<uint32_t>(Dt1), static_cast<uint32_t>(Dt2), static_cast<uint32_t>(Xn), imm7,
                              internal::ldpSimdFpDataTypes::v64bit);
    }

    constexpr uint32_t ldpPre(const V128Bit Qt1, const V128Bit Qt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpPre(static_cast<uint32_t>(Qt1), static_cast<uint32_t>(Qt2), static_cast<uint32_t>(Xn), imm7,
                              internal::ldpSimdFpDataTypes::v128bit);
    }

    constexpr uint32_t ldp(const V32Bit St1, const V32Bit St2, const R64Bit Xn)
    {
      return internal::ldpOffset(static_cast<uint32_t>(St1), static_cast<uint32_t>(St2), static_cast<uint32_t>(Xn), 0,
                                 internal::ldpSimdFpDataTypes::v32bit);
    }

    constexpr uint32_t ldp(const V64Bit Dt1, const V64Bit Dt2, const R64Bit Xn)
    {
      return internal::ldpOffset(static_cast<uint32_t>(Dt1), static_cast<uint32_t>(Dt2), static_cast<uint32_t>(Xn), 0,
                                 internal::ldpSimdFpDataTypes::v64bit);
    }

    constexpr uint32_t ldp(const V128Bit Qt1, const V128Bit Qt2, const R64Bit Xn)
    {
      return internal::ldpOffset(static_cast<uint32_t>(Qt1), static_cast<uint32_t>(Qt2), static_cast<uint32_t>(Xn), 0,
                                 internal::ldpSimdFpDataTypes::v128bit);
    }
    constexpr uint32_t ldpOffset(const V32Bit St1, const V32Bit St2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpOffset(static_cast<uint32_t>(St1), static_cast<uint32_t>(St2), static_cast<uint32_t>(Xn), imm7,
                                 internal::ldpSimdFpDataTypes::v32bit);
    }

    constexpr uint32_t ldpOffset(const V64Bit Dt1, const V64Bit Dt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpOffset(static_cast<uint32_t>(Dt1), static_cast<uint32_t>(Dt2), static_cast<uint32_t>(Xn), imm7,
                                 internal::ldpSimdFpDataTypes::v64bit);
    }

    constexpr uint32_t ldpOffset(const V128Bit Qt1, const V128Bit Qt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpOffset(static_cast<uint32_t>(Qt1), static_cast<uint32_t>(Qt2), static_cast<uint32_t>(Xn), imm7,
                                 internal::ldpSimdFpDataTypes::v128bit);
    }
...
#endif  // MINI_JIT_ARM_INSTRUCTIONS_SIMD_FP_LDP_H