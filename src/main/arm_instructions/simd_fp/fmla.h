...
constexpr uint32_t fmlaByElementScalarHalfPrecision(const uint32_t Hd, const uint32_t Hn, const uint32_t Vm,
...
constexpr uint32_t fmlaByElementVectorHalfPrecision(const fmlaHalfPrecisionTypes T, const uint32_t Vd, const uint32_t Vn, const uint32_t Vm,
    const uint32_t index)
{
    release_assert((Vd & mask5) == Vd, "Vd is only allowed to have a size of 5 bit.");
    release_assert((Vn & mask5) == Vn, "Vn is only allowed to have a size of 5 bit.");
...
constexpr uint32_t fmlaByElementVectorSingleDoublePrecision(const fmlaSingleDoublePrecisionTypes T, const uint32_t Vd, const uint32_t Vn, const uint32_t Vm,
    const uint32_t index, bool isDoublePrecision)
{
    release_assert((Vd & mask5) == Vd, "Vd is only allowed to have a size of 5 bit.");
    release_assert((Vn & mask5) == Vn, "Vn is only allowed to have a size of 5 bit.");
...
{
    return internal::fmlaByElementScalarHalfPrecision(static_cast<uint32_t>(Hd), static_cast<uint32_t>(Hn),
