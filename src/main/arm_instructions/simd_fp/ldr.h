...
namespace mini_jit
{
  namespace arm_instructions
  {
    ...
    namespace internal
    {
      ...
      constexpr uint32_t ldrSimdFpImmediatePost(const uint32_t Vt, const uint32_t Rn, const int32_t imm9, const ldrSimdFpDataTypes type)
      {
      ...
      constexpr uint32_t ldrSimdFpImmediatePre(const uint32_t Vt, const uint32_t Rn, const int32_t imm9, const ldrSimdFpDataTypes type)
      {
        release_assert(((Vt & mask5) == Vt), "Vt is only allowed to have a size of 5 bit.");
        release_assert(((Rn & mask5) == Rn), "Rn is only allowed to have a size of 5 bit.");
        release_assert(imm9 <= 255, "imm9 has a Maximum of 255");
      ...
      constexpr uint32_t ldrSimdFpImmediateOffset(const uint32_t Vt, const uint32_t Rn, const uint32_t imm12, const ldrSimdFpDataTypes type)
      {
        release_assert(((Vt & mask5) == Vt), "Vt is only allowed to have a size of 5 bit.");
        release_assert(((Rn & mask5) == Rn), "Rn is only allowed to have a size of 5 bit.");
