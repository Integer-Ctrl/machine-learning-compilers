...
namespace mini_jit
{
  namespace arm_instructions
  {
    ...
    namespace internal
    {
      ...
      constexpr uint32_t ldpPost(const uint32_t Rt1, const uint32_t Rt2, const uint32_t Rn, const int32_t imm7, const bool is64bit)
      {
        return _ldpPostPreOffset(0b010100011, Rt1, Rt2, Rn, imm7, is64bit);
      }

      constexpr uint32_t ldpPre(const uint32_t Rt1, const uint32_t Rt2, const uint32_t Rn, const int32_t imm7, const bool is64bit)
      {
        return _ldpPostPreOffset(0b010100111, Rt1, Rt2, Rn, imm7, is64bit);
      }

      constexpr uint32_t ldpOffset(const uint32_t Rt1, const uint32_t Rt2, const uint32_t Rn, const int32_t imm7, const bool is64bit)
      {
    ...
    {
      return internal::ldpPost(static_cast<uint32_t>(Wt1), static_cast<uint32_t>(Wt2), static_cast<uint32_t>(Xn), imm7, false);
    }

    constexpr uint32_t ldpPost(const R64Bit Xt1, const R64Bit Xt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpPost(static_cast<uint32_t>(Xt1), static_cast<uint32_t>(Xt2), static_cast<uint32_t>(Xn), imm7, true);
    }

    constexpr uint32_t ldpPre(const R32Bit Wt1, const R32Bit Wt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpPre(static_cast<uint32_t>(Wt1), static_cast<uint32_t>(Wt2), static_cast<uint32_t>(Xn), imm7, false);
    }

    constexpr uint32_t ldpPre(const R64Bit Xt1, const R64Bit Xt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpPre(static_cast<uint32_t>(Xt1), static_cast<uint32_t>(Xt2), static_cast<uint32_t>(Xn), imm7, true);
    }

    constexpr uint32_t ldp(const R32Bit Wt1, const R32Bit Wt2, const R64Bit Xn)
    {
      return internal::ldpOffset(static_cast<uint32_t>(Wt1), static_cast<uint32_t>(Wt2), static_cast<uint32_t>(Xn), 0, false);
    }

    constexpr uint32_t ldp(const R64Bit Xt1, const R64Bit Xt2, const R64Bit Xn)
    {
      return internal::ldpOffset(static_cast<uint32_t>(Xt1), static_cast<uint32_t>(Xt2), static_cast<uint32_t>(Xn), 0, true);
    }

    constexpr uint32_t ldpOffset(const R32Bit Wt1, const R32Bit Wt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpOffset(static_cast<uint32_t>(Wt1), static_cast<uint32_t>(Wt2), static_cast<uint32_t>(Xn), imm7, false);
    }

    constexpr uint32_t ldpOffset(const R64Bit Xt1, const R64Bit Xt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::ldpOffset(static_cast<uint32_t>(Xt1), static_cast<uint32_t>(Xt2), static_cast<uint32_t>(Xn), imm7, true);
    }
