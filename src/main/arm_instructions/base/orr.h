...
template<> constexpr orrShiftType _orrParseShiftType<ShiftLSL>() { return orrShiftType::LSL; }
template<> constexpr orrShiftType _orrParseShiftType<ShiftLSR>() { return orrShiftType::LSR; }
template<> constexpr orrShiftType _orrParseShiftType<ShiftASR>() { return orrShiftType::ASR; }
template<> constexpr orrShiftType _orrParseShiftType<ShiftROR>() { return orrShiftType::ROR; }

constexpr uint32_t orrShiftedRegister(uint32_t Rd, uint32_t Rn, uint32_t Rm, orrShiftType shift, uint32_t imm6,
    bool is64bit)
{
...
template <typename T>
constexpr uint32_t orr(const R32Bit Wd, const R32Bit Wn, const R32Bit Wm, const T, uint32_t amount)
{
...
template <typename T>
constexpr uint32_t orr(const R64Bit Rd, const R64Bit Rn, const R64Bit Rm, const T, uint32_t amount)
{
    internal::orrShiftType shift = internal::_orrParseShiftType<T>();
    return internal::orrShiftedRegister(static_cast<uint32_t>(Rd), static_cast<uint32_t>(Rn), static_cast<uint32_t>(Rm),
        shift, amount, true);
