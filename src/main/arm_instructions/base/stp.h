...
namespace mini_jit
{
  namespace arm_instructions
  {
    ...
    namespace internal
    {
      ...
      constexpr uint32_t stpPost(const uint32_t Rt1, const uint32_t Rt2, const uint32_t Rn, const int32_t imm7, const bool is64bit)
      {
        return _stpPostPreOffset(0b010100010, Rt1, Rt2, Rn, imm7, is64bit);
      }

      constexpr uint32_t stpPre(const uint32_t Rt1, const uint32_t Rt2, const uint32_t Rn, const int32_t imm7, const bool is64bit)
      {
        return _stpPostPreOffset(0b010100110, Rt1, Rt2, Rn, imm7, is64bit);
      }

      constexpr uint32_t stpOffset(const uint32_t Rt1, const uint32_t Rt2, const uint32_t Rn, const int32_t imm7, const bool is64bit)
      {
    ...
    {
      return internal::stpPost(static_cast<uint32_t>(Wt1), static_cast<uint32_t>(Wt2), static_cast<uint32_t>(Xn), imm7, false);
    }

    constexpr uint32_t stpPost(const R64Bit Xt1, const R64Bit Xt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::stpPost(static_cast<uint32_t>(Xt1), static_cast<uint32_t>(Xt2), static_cast<uint32_t>(Xn), imm7, true);
    }

    constexpr uint32_t stpPre(const R32Bit Wt1, const R32Bit Wt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::stpPre(static_cast<uint32_t>(Wt1), static_cast<uint32_t>(Wt2), static_cast<uint32_t>(Xn), imm7, false);
    }

    constexpr uint32_t stpPre(const R64Bit Xt1, const R64Bit Xt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::stpPre(static_cast<uint32_t>(Xt1), static_cast<uint32_t>(Xt2), static_cast<uint32_t>(Xn), imm7, true);
    }

    constexpr uint32_t stp(const R32Bit Wt1, const R32Bit Wt2, const R64Bit Xn)
    {
      return internal::stpOffset(static_cast<uint32_t>(Wt1), static_cast<uint32_t>(Wt2), static_cast<uint32_t>(Xn), 0, false);
    }

    constexpr uint32_t stp(const R64Bit Xt1, const R64Bit Xt2, const R64Bit Xn)
    {
      return internal::stpOffset(static_cast<uint32_t>(Xt1), static_cast<uint32_t>(Xt2), static_cast<uint32_t>(Xn), 0, true);
    }

    constexpr uint32_t stpOffset(const R32Bit Wt1, const R32Bit Wt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::stpOffset(static_cast<uint32_t>(Wt1), static_cast<uint32_t>(Wt2), static_cast<uint32_t>(Xn), imm7, false);
    }

    constexpr uint32_t stpOffset(const R64Bit Xt1, const R64Bit Xt2, const R64Bit Xn, const int32_t imm7)
    {
      return internal::stpOffset(static_cast<uint32_t>(Xt1), static_cast<uint32_t>(Xt2), static_cast<uint32_t>(Xn), imm7, true);
    }
