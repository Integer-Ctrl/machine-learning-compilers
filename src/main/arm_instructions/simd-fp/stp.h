    ...
    const int32_t imm7, const stpSimdFpDataTypes type)
{
    ...
    case stpSimdFpDataTypes::v128bit:
        immShift = 4;
        release_assert(((imm7 >> 4) & mask7) == (imm7 >> 4),
            "imm7 is only allowed to have a size of 7 bit, after shift.");
...
constexpr uint32_t stpPost(const V32Bit St1, const V32Bit St2, const V32Bit Xn, const int32_t imm7)
{
    return internal::stpPost(static_cast<uint32_t>(St1), static_cast<uint32_t>(St2), static_cast<uint32_t>(Xn),
        imm7, internal::stpSimdFpDataTypes::v32bit);
}
...
constexpr uint32_t stpPost(const V64Bit Dt1, const V64Bit Dt2, const R64Bit Xn, const int32_t imm7)
{
    return internal::stpPost(static_cast<uint32_t>(Dt1), static_cast<uint32_t>(Dt2), static_cast<uint32_t>(Xn),
        imm7, internal::stpSimdFpDataTypes::v64bit);
}
...
constexpr uint32_t stpPost(const V128Bit Qt1, const V128Bit Qt2, const R64Bit Xn, const int32_t imm7)
{
    return internal::stpPost(static_cast<uint32_t>(Qt1), static_cast<uint32_t>(Qt2), static_cast<uint32_t>(Xn),
        imm7, internal::stpSimdFpDataTypes::v128bit);
}

constexpr uint32_t stpPre(const V32Bit St1, const V32Bit St2, const V32Bit Xn, const int32_t imm7)
{
    return internal::stpPre(static_cast<uint32_t>(St1), static_cast<uint32_t>(St2), static_cast<uint32_t>(Xn),
        imm7, internal::stpSimdFpDataTypes::v32bit);
}

constexpr uint32_t stpPre(const V64Bit Dt1, const V64Bit Dt2, const R64Bit Xn, const int32_t imm7)
{
    return internal::stpPre(static_cast<uint32_t>(Dt1), static_cast<uint32_t>(Dt2), static_cast<uint32_t>(Xn),
        imm7, internal::stpSimdFpDataTypes::v64bit);
}

constexpr uint32_t stpPre(const V128Bit Qt1, const V128Bit Qt2, const R64Bit Xn, const int32_t imm7)
{
    return internal::stpPre(static_cast<uint32_t>(Qt1), static_cast<uint32_t>(Qt2), static_cast<uint32_t>(Xn),
        imm7, internal::stpSimdFpDataTypes::v128bit);
}

constexpr uint32_t stp(const V32Bit St1, const V32Bit St2, const V32Bit Xn)
{
    return internal::stpPost(static_cast<uint32_t>(St1), static_cast<uint32_t>(St2), static_cast<uint32_t>(Xn),
...
constexpr uint32_t stpOffset(const V32Bit St1, const V32Bit St2, const V32Bit Xn, const int32_t imm7)
{
