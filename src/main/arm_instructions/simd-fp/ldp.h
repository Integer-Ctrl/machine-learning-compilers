...
constexpr uint32_t ldpPost(const V32Bit St1, const V32Bit St2, const V32Bit Xn, const int32_t imm7)
{
...
constexpr uint32_t ldpPre(const V32Bit St1, const V32Bit St2, const V32Bit Xn, const int32_t imm7)
{
...
constexpr uint32_t ldp(const V32Bit St1, const V32Bit St2, const V32Bit Xn)
{
    return internal::ldpPost(static_cast<uint32_t>(St1), static_cast<uint32_t>(St2), static_cast<uint32_t>(Xn),
...
constexpr uint32_t ldpOffset(const V32Bit St1, const V32Bit St2, const V32Bit Xn, const int32_t imm7)
{
