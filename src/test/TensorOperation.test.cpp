...
TEST_CASE("Test tensor operation with main kernel: gemm", "[tensor_operation][gemm][correctness]")
{
  ...
  constexpr TensorConfig::dim_t dim_types[]{TensorConfig::dim_t::m, TensorConfig::dim_t::n, TensorConfig::dim_t::k};
  constexpr TensorConfig::exec_t exec_types[]{TensorConfig::exec_t::prim, TensorConfig::exec_t::prim, TensorConfig::exec_t::prim};
...
TEST_CASE("Test tensor operation with main kernel: brgemm", "[tensor_operation][brgemm][correctness]")
{
  ...
  constexpr TensorConfig::dim_t dim_types[]{TensorConfig::dim_t::k, TensorConfig::dim_t::m, TensorConfig::dim_t::n, TensorConfig::dim_t::k};
  constexpr TensorConfig::exec_t exec_types[]{TensorConfig::exec_t::prim, TensorConfig::exec_t::prim, TensorConfig::exec_t::prim,
...
TEST_CASE("Test tensor operation with outer loop with main kernel: gemm", "[tensor_operation][gemm][correctness]")
{
  ...
  constexpr TensorConfig::dim_t dim_types[]{TensorConfig::dim_t::n, TensorConfig::dim_t::k, TensorConfig::dim_t::c,
 ...
 * #################################################################################################
 *
 *                    Testing of parallel execution (with multiple outer loop)
 *
 * #################################################################################################
 * #################################################################################################
 * #################################################################################################
...
TEST_CASE("Test parallel tensor operation with outer loop with main kernel: gemm", "[tensor_operation][gemm][correctness]")
{
  ...
  constexpr int64_t strides_in0[]{0,                          // n-dim
                                  ...
                                  0,                          // n-dim-prim
                                  32};                        // k-dim-prim
  constexpr int64_t strides_in1[]{32 * 32 * 1 * 13 * 1 * 5 * 1,
                                  0,  // m-dim
                                  32 * 32 * 1 * 13 * 1,
                                  0,  // m-dim
                                  32 * 32 * 1,
                                  ...
                                  32,
                                  1};
  constexpr int64_t strides_out[]{32 * 32 * 21 * 1 * 8 * 5 * 3,
                                  32 * 32 * 21 * 1 * 8 * 5,  // m-dim
                                  32 * 32 * 21 * 1 * 8,
                                  32 * 32 * 21 * 1,
                                  0,  // k-dim
                                  32 * 32,
  ...
  GenerationTest test(32, 32, 32, 1, 32 * 32 * 21 * 13 * 8 * 5 * 3 * 1, 32 * 32 * 1 * 13 * 1 * 5 * 1 * 2, 32 * 32 * 21 * 1 * 8 * 5 * 3 * 2);
  test.SetUp(TestInfill::Random);
...
TEST_CASE("Test parallel tensor operation with outer loop with main kernel: brgemm", "[tensor_operation][brgemm][correctness]")
{
  using namespace mini_jit;
  ...
  constexpr int64_t strides_in0[]{0,                              // n-dim
                                  ...
                                  0,                              // n-dim-prim
                                  32};                            // k-dim-prim
  constexpr int64_t strides_in1[]{32 * 32 * 3 * 1 * 13 * 1 * 5 * 1,
                                  0,  // m-dim
                                  32 * 32 * 3 * 1 * 13 * 1,
                                  0,  // m-dim
                                  32 * 32 * 3 * 1,
  ...
  GenerationTest test(32, 32, 32, 3, 32 * 32 * 3 * 21 * 13 * 8 * 5 * 3 * 1, 32 * 32 * 3 * 1 * 13 * 1 * 5 * 1 * 2,
                      32 * 32 * 21 * 1 * 8 * 5 * 3 * 2);
  test.SetUp(TestInfill::Random);
...
TEST_CASE("Test parallel tensor operation with outer loop with first touch: unary (zero, relu, copy)",
          "[tensor_operation][unary][correctness]")
{
  using namespace mini_jit;
  ...
  constexpr int64_t strides_in0[]{0,                              // n-dim
                                  ...
                                  0,                              // n-dim-prim
                                  32};                            // k-dim-prim
  constexpr int64_t strides_in1[]{32 * 3 * 32 * 1 * 13 * 1 * 5 * 1,
                                  0,  // m-dim
                                  32 * 3 * 32 * 1 * 13 * 1,
                                  0,  // m-dim
                                  32 * 3 * 32 * 1,
  ...
  GenerationTest test(32, 32, 32, 3, 32 * 3 * 32 * 21 * 13 * 8 * 5 * 3 * 1, 32 * 3 * 32 * 1 * 13 * 1 * 5 * 1 * 2,
                      32 * 32 * 21 * 1 * 8 * 5 * 3 * 2);
  test.SetUp(TestInfill::Random);
...
TEST_CASE("Test parallel tensor operation with outer loop with last touch: unary (zero, relu, copy)",
          "[tensor_operation][unary][correctness]")
{
  using namespace mini_jit;
...
TEST_CASE(
  "Test parallel tensor operation with outer loop with first touch: unary (zero, relu, copy) & main kernel: brgemm & last touch: unary "
  "(zero, relu, copy)",
  "[tensor_operation][unary][brgemm][correctness]")
{
  using namespace mini_jit;
  ...
  constexpr int64_t strides_in0[]{0,                              // n-dim
                                  ...
                                  0,                              // n-dim-prim
                                  16};                            // k-dim-prim
  constexpr int64_t strides_in1[]{16 * 16 * 3 * 1 * 13 * 1 * 5 * 1,
                                  0,  // m-dim
                                  16 * 16 * 3 * 1 * 13 * 1,
                                  0,  // m-dim
                                  16 * 16 * 3 * 1,
                                  ...
                                  16,
                                  1};
  constexpr int64_t strides_out[]{16 * 16 * 21 * 1 * 8 * 5 * 3,
